...
namespace CombatAndroid::ECS {
    namespace {
        ...
        constexpr EnemyDifficultyEntry kDifficultyTable[] = {
            ...
            {180.0f, 1.60f, 1.20f, 1.16f, 1.20f},
            {240.0f, 1.90f, 1.30f, 1.24f, 1.28f},
            {300.0f, 2.20f, 1.40f, 1.32f, 1.36f},    // 危険度6：湧き間隔の詰めきり（kIntervalRampSeconds=300）と同時
            {360.0f, 2.50f, 1.52f, 1.40f, 1.44f},
            {420.0f, 2.80f, 1.64f, 1.48f, 1.52f},
            {480.0f, 3.10f, 1.78f, 1.56f, 1.60f},
            {540.0f, 3.40f, 1.92f, 1.64f, 1.68f},    // 危険度10：プレイヤーの伸びしろ（約3.2倍）とほぼ釣り合う
        };
        ...
        //-------------------------------------------------------------
        constexpr EnemyDifficultyEntry kContinuation{kDangerRankIntervalSeconds, 0.30f, 0.14f, 0.08f, 0.08f};
